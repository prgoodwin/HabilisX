...
namespace MicrosoftResearch.Infer.Factors
{
    ...
    /// <summary>
    /// Provides outgoing messages for <see cref="Factor.CountTrue"/>, given random arguments to the function.
    /// </summary>
    ...
    public static class CountTrueOp
    {
        ...
        /// </para></remarks>
        /// <exception cref="ImproperMessageException"><paramref name="count"/> is not a proper distribution</exception>
        [Skip]
        ...
        {
            Debug.Assert(averager.Dimension == array.Count + 1, "'averager' should represent a distribution over sum of the elements of 'array'.");
