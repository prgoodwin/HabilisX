...
namespace MicrosoftResearch.Infer.Factors
{
	...
	public static class GetItemsOp<T>
	{
		...
		[SkipIfAllUniform]
		public static ArrayType Marginal<ArrayType, DistributionType>(ArrayType array, [NoInit] IList<DistributionType> items, IList<int> indices, ArrayType result)
		...
		public static ArrayType MarginalIncrement<ArrayType, DistributionType>(ArrayType result, DistributionType to_item, [SkipIfUniform] DistributionType item, IList<int> indices, int resultIndex)
			where ArrayType : IList<DistributionType>, SettableTo<ArrayType>
			where DistributionType : SettableToProduct<DistributionType>
		{
			int i = resultIndex;
