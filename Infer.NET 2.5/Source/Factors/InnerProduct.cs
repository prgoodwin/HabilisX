...
namespace MicrosoftResearch.Infer.Factors
{
	...
	public static class InnerProductOp
	{
		...
		/// <exception cref="ImproperMessageException"><paramref name="B"/> is not a proper distribution</exception>
		public static VectorGaussian AAverageLogarithm([SkipIfUniform] Gaussian innerProduct, [SkipIfUniform] VectorGaussian B, Vector BMean, PositiveDefiniteMatrix BVariance, VectorGaussian result)
		{
		...
		/// <exception cref="ImproperMessageException"><paramref name="innerProduct"/> is not a proper distribution</exception>
		/// <exception cref="ImproperMessageException"><paramref name="A"/> is not a proper distribution</exception>
		public static VectorGaussian BAverageLogarithm([SkipIfUniform] Gaussian innerProduct, [SkipIfUniform] VectorGaussian A, Vector AMean, PositiveDefiniteMatrix AVariance, VectorGaussian result)
		{
