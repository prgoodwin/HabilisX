...
namespace MicrosoftResearch.Infer.Factors
{
  ...
  [FactorMethod(typeof(Factor), "Product", typeof(double), typeof(double))]
	...
	{
		public static Gaussian ProductAverageConditional2(Gaussian product, [SkipIfUniform] Gaussian A, [SkipIfUniform] Gaussian B, [NoInit] Gaussian to_A, [NoInit] Gaussian to_B)
		{
    ...
    public static Gaussian AAverageConditional([SkipIfUniform] Gaussian Product, [Proper/*, Fresh*/] Gaussian B, [NoInit] Gaussian to_B)
		...
		public static double LogEvidenceRatio([SkipIfUniform] Gaussian Product, [SkipIfUniform] Gaussian A, [SkipIfUniform] Gaussian B, Gaussian to_A, Gaussian to_B, Gaussian to_product)
		{
	...
	public static class GaussianProductOp_Laplace
	{
		...
		public static Gaussian GaussianFromAlphaBeta(Gaussian prior, double alpha, double beta, bool forceProper)
		{
			...
			if (forceProper && (prec == beta || weight < 0)) weight = 0;
			...
			if (double.IsNaN(resultPrecision) || double.IsNaN(resultMeanTimesPrecision)) throw new ApplicationException("result is nan");
