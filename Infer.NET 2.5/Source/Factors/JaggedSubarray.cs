...
namespace MicrosoftResearch.Infer.Factors
{
	...
	public static class JaggedSubarrayOp<T>
	{
		...
		[SkipIfAllUniform]
		public static ArrayType Marginal<ArrayType, DistributionType, ItemArrayType, ItemType>(ArrayType array, [NoInit] IList<ItemType> items, IList<int[]> indices, ArrayType result)
		...
		// SkipIfUniform on 'item' causes this line to be pruned when the backward messages aren't changing
		public static ArrayType MarginalIncrement<ArrayType, DistributionType, ItemType>(ArrayType result, ItemType to_item, [SkipIfUniform] ItemType item, IList<int[]> indices, int resultIndex)
			where ArrayType : IList<DistributionType>, SettableTo<ArrayType>
			where DistributionType : SettableToProduct<DistributionType>
			where ItemType : IList<DistributionType>
		{
