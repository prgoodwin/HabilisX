...
namespace MicrosoftResearch.Infer.Factors
{
    ...
    public static double Product_SHG09(double a, double b) { return a * b; }
    /// <summary>
		...
		public static PositiveDefiniteMatrix Product(PositiveDefiniteMatrix a, double b) { return a*b; }
		/// <summary>
		...
		public static PositiveDefiniteMatrix Product(double a, PositiveDefiniteMatrix b) { return b*a; }
		/// <summary>
		...
		public static T Copy<T>([SkipIfUniform] T value) { return value; }
