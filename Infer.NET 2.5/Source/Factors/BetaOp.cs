...
namespace MicrosoftResearch.Infer.Factors
{
	...
	public static class BetaOp
	{
		...
		public static Beta MeanAverageLogarithm([Proper] Beta prob, Beta mean, double totalCount, Beta to_mean)
		{
			return MeanAverageLogarithm(prob, mean, Gamma.PointMass(totalCount), to_mean);
		}
		...
		/// <exception cref="ImproperMessageException"><paramref name="mean"/> is not a proper distribution</exception>
		/// <exception cref="ImproperMessageException"><paramref name="totalCount"/> is not a proper distribution</exception>
		public static Gamma TotalCountAverageLogarithm([Proper] Beta mean, Gamma totalCount, double prob, Gamma to_totalCount)
		{
