...
namespace MicrosoftResearch.Infer.Distributions
{
	...
	public abstract class GenericDiscreteBase<T, TThis> : IDistribution<T>, SettableTo<TThis>, SettableToProduct<TThis>,
		SettableToRatio<TThis>, SettableToPower<TThis>, SettableToWeightedSum<TThis>, 
		...
		where TThis : GenericDiscreteBase<T,TThis>, new()
	{
		...
		/// </summary>
		public int Dimension { get { return disc.Dimension; } }
		...
		public double this[T value]
		{
			get
			{
				return disc[ConvertToInt(value)];
			}
		}
		...
		public T Point
		{
			get
			{
				return ConvertFromInt(disc.Point);
			}
			set
			{
				disc.Point = ConvertToInt(value);
			}
		}
		...
		public void SetTo(TThis value) { disc.SetTo(value.disc); }
		/// <summary>
		...
		public void SetToProduct(TThis a, TThis b) { disc.SetToProduct(a.disc, b.disc); }
		/// <summary>
		...
		public void SetToRatio(TThis numerator, TThis denominator, bool forceProper) { disc.SetToRatio(numerator.disc, denominator.disc, forceProper); }
		...
		public void SetToPower(TThis value, double exponent) { disc.SetToPower(value.disc, exponent); }
		...
		public void SetToSum(double weight1, TThis value1, double weight2, TThis value2) { disc.SetToSum(weight1, value1.disc, weight2, value2.disc); }
		...
		public double GetLogAverageOf(TThis that) { return disc.GetLogAverageOf(that.disc); }
		...
		/// <returns></returns>
		public double GetLogAverageOfPower(TThis that, double power) { return disc.GetLogAverageOfPower(that.disc, power); }
		...
		public double GetAverageLog(TThis that) { return disc.GetAverageLog(that.disc); }
