...
namespace MicrosoftResearch.Infer.Distributions
{
	...
	public sealed class EstimatorFactory
	{
		...
		private EstimatorFactory()
		{
			...
			RegisterEstimator(typeof(VectorGaussian), typeof(VectorGaussianEstimator), delegate(object dst) { return new VectorGaussianEstimator(((VectorGaussian)dst).Dimension); });
